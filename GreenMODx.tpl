...
<title>[(site_name)] | [*pagetitle*]</title>
	...
	<link rel="stylesheet" href="[(base_url)]assets/templates/GreenMODx/site.css" type="text/css" media="screen" />
...
<div id="page">
  <div id="header">
  <div id="TopBar">
      <div id="Navbar1"> [!Wayfinder? &amp;startId=`0` &amp;level=`1`!] </div>
	  <div id="Navbar2"> [!Wayfinder? &amp;startDoc=[*parent*] &amp;level=`1`!] </div>
    </div>
